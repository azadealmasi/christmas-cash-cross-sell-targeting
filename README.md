...
```
.
├── data/                     # Datasets used for analysis and modelling
│   └── data.xlsx
...
│   ├── Campaign_Contacts_Overall_Overview.jpg
    ├──Contacts_Selection_Overview_Dashboard.jpg
    ├──Target_Market_Profile_Dashboard.jpg
